...
def upgrade() -> None:
    ...
    op.alter_column('production_entries', 'width_cm', nullable=False, existing_type=sa.Integer())
    op.alter_column('production_entries', 'height_cm', nullable=False, existing_type=sa.Integer())
    op.alter_column('production_entries', 'production_cost', nullable=False, existing_type=sa.Float())
